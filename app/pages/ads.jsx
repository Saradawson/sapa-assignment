        ...
        <section className="flex flex-col items-center min-w-full">
          <div className="flex flex-col items-center max-w-fit">
            <Image 
              ...
              height={300}
            />
            <div className="flex items-start justify-start py-20 gap-20">
              <Image 
